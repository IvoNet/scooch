import speakerViewHTML from 'reveal.js/plugin/notes/speaker-view.html?raw';

import { marked } from 'marked';

/* THIS FILE IS COPIED FROM node_modules/reveal.js/plugin/notes/plugin.js AND HAS BEEN CUSTOMIZED */

...
import { type ThemeOptions, loadTheme } from "./load-theme";
...
export const RevealSlides = component$<RevealSlidesProps>(
  ({ defaultTheme }) => {
    ...
    useVisibleTask$(async () => {
      ...
      await loadTheme((themeParam ?? defaultTheme) as ThemeOptions);

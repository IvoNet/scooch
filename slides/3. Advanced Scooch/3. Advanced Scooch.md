...
Themes are CSS files and are put in the `/templates` volume. This volume can also be mounted in the same way as the above examples
...
```json
{
  ...
  "template": "ivonet",
  "transition": "convex",
  "disableChalkboard": false,
  "readOnlyChalkboard": false
}
```
---

...
```json
{
  ...
  "mouseWheel": true, //boolean
  "slideNumber": true, //boolean
  "presenterNotes":true, //boolean
  "center":true, //boolean
  "theme":"beige", // must be one of the options you can see in the pull down menu as a string
  "template":"ivonet", // must be one of the options you can see in the pull down menu as a string
  "transition": "slide" // must be one of the options you can see in the pull down menu as a string
}
```
---
## docker-compose (1/3)
